...
namespace Core.Animations.External
{
    public class TrashHoleFallAnimation
    {
        ...
        public void StartFallAnimation(GameObject objectToAnimate, Vector3 holeCenter, Canvas canvas,
            Action onMiddle = null, Action onComplete = null)
        {
            ...
            Debug.Log(
                $"TrashHoleFallAnimation: Start: {m_StartPosition}, Target: {m_TargetPosition}, Hole: {holeCenter}");
